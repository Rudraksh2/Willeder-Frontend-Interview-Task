...
const reducer = (state: { loading:boolean; data: any; currentPage: number; }, action: { type: any; payload: {loading? :boolean; data?: any; }; }) => {
  switch (action.type) {
    case "set": {
      return {
        ...state,
...
const useLazyLoad = ({ triggerRef, onGrabData, options }) => {
  ...
  const onIntersect = useCallback(
    (entries: { boundingClientRect: any; intersectionRect: any; isIntersecting: any; }[]) => {
